...
| **Create/implement/fetch anything needed**                        | `./scripts/run-onewishos-needful.sh` [--all \| --preset \| --step \| --steps \| --list] | One-shot (--all), multi-step (--steps A,B,C), single-step (--step X); presets: onewishos_all, needful_minimal, needful_full. Config: config/onewishos-needful-steps.yaml.                                                                                                                          |
